            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Treten Sie ein in die Zukunft der modernen Arbeit mit Timely
                  und maximieren Sie das Potenzial Ihres Teams.
                </p>
                <p className="flex items-center text-sm font-medium text-dark ">
                  ...
                  <span>+49 (2402) 678 99</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Timely">
              <NavLink link="/#" label="Startseite" />
              <NavLink link="/#" label="Preise" />
              <NavLink link="/#" label="Roadmap" />
              <NavLink link="/#" label="Integrationen" />
            </LinkGroup>
            <LinkGroup header="Funktionen">
              <NavLink link="/#" label="Teamplanung" />
              <NavLink link="/#" label="Projektmanagement" />
              <NavLink link="/#" label="Zeitkontenmanagement" />
            </LinkGroup>
            <LinkGroup header="Über uns">
              <NavLink link="/#" label="Über uns" />
              <NavLink link="/#" label="Jobs" />
              <NavLink link="/#" label="Datenschutz" />
              <NavLink link="/#" label="Impressum" />
            </LinkGroup>
